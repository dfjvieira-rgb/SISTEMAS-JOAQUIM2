// FolhaEngine.js - VERSÃO ELITE PRECISÃO MÁXIMA [2026-02-03]
export const FolhaEngine = {
    montar: (containerId) => {
        ...
        const styleId = 'style-folha-elite-final';
        if (!document.getElementById(styleId)) {
            ...
            style.innerHTML = `
                ...
                .area-editor {
                    outline: none;
                    padding: 0 25px; /* Margem interna para o texto não colar na borda */
                    font-size: 19px !important;
                    font-weight: 700 !important;
                    color: #000 !important;
                    
                    /* CONTROLE DE MARGEM E QUEBRA */
    ...
    visualizarImpressao: () => {
        ...
        papel.style = "background:white; width:100%; max-width:850px; padding:50px; box-shadow:0 15px 50px rgba(0,0,0,0.5); margin-bottom: 50px;";
        ...
        for(let i=1; i<=150; i++) {
            ...
            html += `
                <div style="display:flex; min-height:35px; border-bottom:1px solid #d1d5db; align-items:flex-start; box-sizing:border-box;">
                    ...
                    <span style="flex:1; font-family:'Courier New', monospace; font-size:19px; font-weight:700; line-height:35px; white-space:pre-wrap; word-break:break-word; padding-top:0;">${textoLinha}</span>
                </div>`;
        }
